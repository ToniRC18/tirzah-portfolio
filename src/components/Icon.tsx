...
export default function Icon({ name, size = 18, stroke = 1.6, ...rest }: IconProps) {
  const s = size;
  const props = {
  ...
  switch (name) {
    ...
    case "id-card": return <svg {...props}><rect x="2" y="4" width="20" height="16" rx="2"/><circle cx="8" cy="12" r="2.5"/><line x1="14" y1="9" x2="19" y2="9"/><line x1="14" y1="13" x2="19" y2="13"/><line x1="14" y1="17" x2="17" y2="17"/></svg>;
    case "quote": return <svg {...props}><path d="M3 21c3 0 7-1 7-8V5c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2v6c0 1.1.9 2 2 2h2"/><path d="M14 21c3 0 7-1 7-8V5c0-1.1-.9-2-2-2h-4c-1.1 0-2 .9-2 2v6c0 1.1.9 2 2 2h2"/></svg>;
    ...
    case "lightbulb": return <svg {...props}><path d="M9 18h6"/><path d="M10 22h4"/><path d="M12 2a7 7 0 0 0-4 12.74V17h8v-2.26A7 7 0 0 0 12 2z"/></svg>;
    ...
    case "leaf": return <svg {...props}><path d="M11 20A7 7 0 0 1 4 13V8a5 5 0 0 1 5-5h7a5 5 0 0 1 5 5v5a7 7 0 0 1-7 7"/><path d="M9 14l6-6"/></svg>;
